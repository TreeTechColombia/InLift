...
<html lang="en">
        ...
        <div id="carouselExampleIndicators" class=" carousel slide" data-ride="carousel"
            ...
            <div class="carousel-inner" style="margin-bottom: 10px">
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100 imgSlide" src="Assets/Fondos/EOscuroEle.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 imgSlide" src="Assets/Fondos/ElevadorLargo.png" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100 imgSlide" src="Assets/Fondos/ascensoresConce.jpg" width="50%"
                         height="50%" alt="third slide">
                </div>
            </div>
    ...
    <div class="container contenedorInfoInicio" style="text-align: center;">
        <div class="card text-align-center "
            ...
            <p style="text-align: justify; color: whitesmoke;"> <i> Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Illum delectus amet itaque similique a, eius perspiciatis rem facilis, ab quaerat nulla animi
        ...
        <div class="card text-align-center cartaInicio"
             style="background-color: rgba(245, 222, 179, 0.2); border-color: rgb(245, 222, 179); margin-right: 5px; padding: 15px;">
            <h2 style="color: white;">¿Por qué elegirnos?</h2>
            <p style="text-align: justify; color: whitesmoke;"> <i> Lorem ipsum dolor sit, amet consectetur adipisicing
                    elit. Illum delectus amet itaque similique a, eius perspiciatis rem facilis, ab quaerat nulla animi
                    ad vel enim fugit magni deleniti cumque nesciunt. Lorem ipsum, dolor sit amet consectetur
                    adipisicing elit. Magni ipsa dolore possimus voluptate dicta quas esse facilis doloremque quae,
    ...
    <div class="container my-4 contenedorInfoInicio" style="text-align: center;">
        <div class="container" style="width: 100%; height: 100%; margin-right: 10px;">
            <div class="container imgSlide"
                ...
                <img src="Assets/ascensorEnter.jpg" alt="" class=" img-fluid" style="
                     margin: 10px 10px;
        ...
        <div class="text-align-center">
            <div class="card text-align-center"
                ...
                <div class="container" style="justify-content: center; text-align: justify;">
                    <p style="text-align: justify; color: whitesmoke;"> <i> Los ascesores de home de nuestra empresa se
                            caracterizan porque Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae ut
                            animi sed officia doloremque esse quidem pariatur! Consequatur? </i> </p>
                </div>
                <div style="justify-content: start;">
                    <button class="btn btn-info"
                            style="background-color: rgba(245, 222, 179, 0.2); border-color: rgb(245, 222, 179);"> ¡Quiero
                        saber más!</button>
                </div>
            </div>
            <div class="card text-align-center"
                 style="margin-top: 20px ;background-color: rgba(245, 222, 179, 0.2); border-color: rgb(245, 222, 179); margin-right: 5px; padding: 15px;">
                <h3 style="color: white;">INSTITUCIONAL</h3>
                <div class="container" style="justify-content: center; text-align: justify;">
                    <p style="text-align: justify; color: whitesmoke;"> <i> Los ascesores de tipo institucional de
                            nuestra empresa se caracterizan porque Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Molestiae ut animi sed officia doloremque esse quidem pariatur! Consequatur? </i> </p>
                </div>
                <div style="justify-content: start;">
                    <button class="btn btn-info"
                            style="background-color: rgba(245, 222, 179, 0.2); border-color: rgb(245, 222, 179);"> ¡Quiero
            ...
            <div class="card text-align-center"
                 style="margin-top: 20px ;background-color: rgba(245, 222, 179, 0.2); border-color: rgb(245, 222, 179); margin-right: 5px; padding: 15px;">
                <h3 style="color: white;">CARGA</h3>
                <div class="container" style="justify-content: center; text-align: justify;">
                    <p style="text-align: justify; color: whitesmoke;"> <i> Los ascesores de carga de nuestra empresa se
                            caracterizan porque Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae ut
                            animi sed officia doloremque esse quidem pariatur! Consequatur? </i> </p>
                </div>
                <div style="justify-content: start;">
